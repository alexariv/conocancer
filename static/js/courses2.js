...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const lessonTitles = {
    ...
    es: {
      video: {
        1: "Qué Significa Tener Senos Densos",
        2: "Autoexamen de Mamas",
        3: "Detección de Mamas",
      },
      reading: {
  ...
  updateLessonTitles();
   ...
   const videoMap = {
    en: {
      1: "What_Does_It_Mean_to_Have_Dense_Breasts_01E.mp4",
      2: "Breast_Self_Exam_05E.mp4",
      3: "Breast_Screening_Program_10E.mp4",
    },
    es: {
      1: "What_Does_It_Mean_to_Have_Dense_Breasts_01S.mp4",
      2: "Breast_Self_Exam_05S.mp4",
      3: "Breast_Screening_Program_10S.mp4",
    }
  };
