...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const videoMap = {
    en: {
      1: "What_Does_It_Mean_to_Have_Dense_Breasts_03E.mp4",
      2: "Breast_Self_Exam_03E.mp4",
      3: "Understanding_Mammograms_03E.mp4", // Corrected filename
      4: "Breast_Screening_Program_Client_Information_Video_03E.mp4",
    },
    es: {
      1: "What_Does_It_Mean_to_Have_Dense_Breasts_03S.mp4",
      2: "Breast_Self_Exam_03S.mp4",
      3: "Understanding_Mammograms_03S.mp4",
      4: "Breast_Screening_Program_Client_Information_Video_03S.mp4",
    }
  };
  ...
  lessons.forEach(lesson => {
    lesson.addEventListener("click", () => {
      ...
      if (type === "video") {
        ...
        breadcrumb.innerText = `Screening & Detection › ${title}`;
      } else if (type === "reading") {
        loadReading();
        readingSection.style.display = "block";
        breadcrumb.innerText = `Screening & Detection › ${currentLanguage === "en" ? "Reading" : "Lectura"}`;
      } else if (type === "quiz") {
        loadQuiz(id);
        quizSection.style.display = "block";
        breadcrumb.innerText = `Screening & Detection › ${currentLanguage === "en" ? "Quiz" : "Cuestionario"}`;
      }
    });
  });
